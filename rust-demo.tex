...
%\footnote{One can also program using types analogous to ML's {\tt ref} and arrays.}
%
%This introduces the potential for references that alias each other in non-obvious ways.
